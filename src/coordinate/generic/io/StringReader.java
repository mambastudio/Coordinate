...
public class StringReader {
    ...
    public StringReader(BufferedReader bf)
    {
        this.line = "";
        this.bf = bf;
    ...
    public StringReader(String directory, String file)
    {
    ...
    public static StringReader getStringParser(File file)
    {
        try
        {
            if(!file.exists())
            ...
            {
                StringReader parser = new StringReader(Files.newBufferedReader(file.toPath(), Charset.defaultCharset()));
                return parser;
            }
        }
        catch (IOException ex) 
