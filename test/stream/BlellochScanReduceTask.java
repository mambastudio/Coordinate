 ...
 * @author jmburu
 */
public class BlellochScanReduceTask extends RecursiveAction {
    public static final int SEQUENTIAL_THRESHOLD = 2; // Adjust threshold as needed
    ...
    public BlellochScanReduceTask(NativeInteger input, long start, long end, int carry) {
        this.input = input;
        this.start = start;
        this.end = end;
        this.carry = carry;
