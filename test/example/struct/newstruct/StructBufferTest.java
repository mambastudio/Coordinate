 ...
 * @author user
 */
public class StructBufferTest {
    public static void main(String... args)
    {
        StructArrayBuffer<Intersection> arrayBox = new StructArrayBuffer<>(Intersection.class, 4);
...
*/
    ...
    public static class Intersection extends StructByte
    {   
    ...
    public static class Atom extends StructByte
    {
        public int charge;
    }
